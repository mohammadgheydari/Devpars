...
<div class="body-content">
    <div class="grey row-padding center">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 right">
                    <h2><?php bloginfo('name'); ?></h2>
                    <h3 class="lead"><?php bloginfo('description'); ?></h3>
                    <p><a href="http://asp.net" class="btn btn-success btn-lg hvr-sweep-to-right">Learn more</a></p>
    ...
    <div class="container">
        <div class="row row-padding ">
            <div class="col-md-4 center col-padding">
                ...
                <p><a class="btn btn-info hvr-float-shadow" href="http://go.microsoft.com/fwlink/?LinkId=301866">Learn
                        more &raquo;</a></p>
            </div>
            <div class="col-md-4 center col-padding">
                <div class="usp-image">
                ...
                <p>NuGet is a free Visual Studio extension that makes it easy to add, remove, and update libraries.</p>
                <p><a class="btn btn-info hvr-float-shadow" href="http://go.microsoft.com/fwlink/?LinkId=301866">Learn
                        more &raquo;</a></p>
            </div>
            <div class="col-md-4 center col-padding">
